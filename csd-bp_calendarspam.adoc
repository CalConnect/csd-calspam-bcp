...
1. Calendar spam, unlike email, can be placed chronologically anywhere in calendars, in 
the past or the future, not just the present, making it difficult detect at the time of 
delivery.

2. Spam meeting invitations, may automatically see these unwanted invitations added to 
...
3. Calendar events and meeting invitations do not yet carry the rich provenance (detailed 
...
4. Calendar events often contain notifications/alarms which are often propagated across 
